        ...
        function displayPlanTable(data) {
            ...
            data.forEach((rowObj, rIdx) => {
                ...
                // Bouton disquette pour générer le plan de leçon IA pour cette ligne (seulement pour l'admin)
                ...
                // Bouton pour télécharger le plan de leçon (si disponible, seulement pour l'admin)
                if (loggedInUser === 'Mohamed' && rowObj && rowObj.lessonPlanId) {
